...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnOk.setOnClickListener(clickOkListener);
    }
    ...
    private final View.OnClickListener clickOkListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(MainActivity.this, "Оплата счета: \n"+"Сумма: "+mInputMoney.getText().toString()+"\n" + "Информация: "+ mInputInfo.getText().toString(), Toast.LENGTH_LONG).show();
